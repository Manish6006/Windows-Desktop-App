...
namespace odishatravel
{
    ...
    public sealed partial class BasicPage1 : Page
    {
        ...
        private void templesButton_Click(object sender, RoutedEventArgs e)
        {
        ...
        {
            this.Frame.Navigate(typeof(BasicPage4), null);
        }

        private void parkButton_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(BasicPage5), null);
        }

        private void aboutButton_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(BasicPage6), null);
        }
    }
}
